...
# -- THE BOTTOM ONE IS THE ACTUAL PROGRAM AND IT EVEN STORES THE RESULTS IN A HASH KEY VALUE PAIR WHERE THE KEY IS "Santa#" AND THE VALUE IS THE CORRESPONDING INSTANCE DATA --
